        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-9 lg:gap-12 pb-[60px] border-b border-[rgba(255,255,255,0.12)]">
          <div>
            ...
            <div className="flex gap-[14px] mt-6">
              <a href="#" aria-label="Instagram" className="w-9 h-9 border border-[rgba(255,255,255,0.18)] rounded-full inline-flex items-center justify-center transition-colors duration-[250ms] hover:border-accent-gold hover:text-accent-gold">
              ...
              <a href="#" aria-label="LinkedIn" className="w-9 h-9 border border-[rgba(255,255,255,0.18)] rounded-full inline-flex items-center justify-center transition-colors duration-[250ms] hover:border-accent-gold hover:text-accent-gold">
