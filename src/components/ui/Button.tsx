...
export function Button({ href, variant = 'primary', withArrow, className = '', children, ...props }: ButtonProps) {
  const baseClass = "font-sans inline-flex items-center gap-2.5 px-7 py-[15px] rounded-full text-sm tracking-[0.04em] font-medium transition-all duration-350 ease-[cubic-bezier(0.2,0.7,0.2,1)] border border-transparent leading-none cursor-pointer group";
