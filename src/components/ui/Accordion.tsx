    ...
    <div className="max-w-[840px] mx-auto border-t border-line">
      {items.map((item, i) => (
        <details key={i} className="group border-b border-line py-6 cursor-pointer">
          <summary className="flex justify-between items-center list-none font-serif text-xl sm:text-2xl text-charcoal gap-4 sm:gap-6 [&::-webkit-details-marker]:hidden">
            {item.q}
